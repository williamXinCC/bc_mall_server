package com.william.bc_mall_server.aspect;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(* com.william.bc_mall_server.controller.*.*(..))")
    ...
    public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
        ...
        sb.append("\"ARGS\":\"").append(JSONUtil.toJsonStr(pjp.getArgs())).append("\",");
        Object result;
        try {
            result = pjp.proceed();
        } catch (Exception e) {
            ...
            if (e instanceof ResponseException) {
                ...
                result = new Result(responseException.getCode(), responseException.getMessage());
            } else {
